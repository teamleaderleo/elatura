...
- **#132 / `application-lane-lifecycle`** owns requested residency posture and generation-bound browser-resource planning.
- **PR #124 / lane governor work** explores browser discard/wake advice and human/agent lease policy.
